...
#define GPIOA_LED4                     1U
#define GPIOA_PIN2                     2U
#define GPIOA_PIN3                     3U
#define GPIOA_LED5                     4U
#define GPIOA_PIN5                     5U
#define GPIOA_LED6                     6U
#define GPIOA_LED7                     7U
...
#define GPIOF_LED2                     0U
#define GPIOF_LED3                     1U
...
#define LINE_LED2                      PAL_LINE(GPIOF, 0U)
#define LINE_LED3                      PAL_LINE(GPIOF, 1U)
#define LINE_LED4                      PAL_LINE(GPIOA, 1U)
#define LINE_LED5                      PAL_LINE(GPIOA, 4U)
#define LINE_LED6                      PAL_LINE(GPIOA, 6U)
#define LINE_LED7                      PAL_LINE(GPIOA, 7U)
#define LINE_LED8                      PAL_LINE(GPIOB, 1U)
 ...
 * PA2  - PIN2                         (unused).
 * PA3  - PIN3                         (unused).
 * PA4  - LED5                         (output, pushpull, startlow).
 * PA5  - PIN5                         (unused).
 * PA6  - LED6                         (af1).
 * PA7  - LED7                         (af1).
 * PA8  - PIN8                         (unused).
...
#define VAL_GPIOA_MODER                (PIN_MODE_ALTERNATE(GPIOA_LED1) | \
                                        ...
                                        PIN_MODE_OUTPUT(GPIOA_LED5) | \
                                        PIN_MODE_INPUT(GPIOA_PIN5) | \
                                        PIN_MODE_ALTERNATE(GPIOA_LED6) | \
                                        PIN_MODE_ALTERNATE(GPIOA_LED7) | \
...
#define VAL_GPIOA_OTYPER               (PIN_OTYPE_PUSHPULL(GPIOA_LED1) | \
                                        ...
                                        PIN_OTYPE_PUSHPULL(GPIOA_LED5) | \
                                        PIN_OTYPE_PUSHPULL(GPIOA_PIN5) | \
                                        PIN_OTYPE_PUSHPULL(GPIOA_LED6) | \
                                        PIN_OTYPE_PUSHPULL(GPIOA_LED7) | \
...
#define VAL_GPIOA_OSPEEDR              (PIN_OSPEED_HIGH(GPIOA_LED1) | \
                                        ...
                                        PIN_OSPEED_HIGH(GPIOA_LED5) | \
                                        PIN_OSPEED_HIGH(GPIOA_PIN5) | \
                                        PIN_OSPEED_HIGH(GPIOA_LED6) | \
                                        PIN_OSPEED_HIGH(GPIOA_LED7) | \
...
#define VAL_GPIOA_PUPDR                (PIN_PUPD_PULLUP(GPIOA_LED1) | \
                                        PIN_PUPD_PULLUP(GPIOA_LED4) | \
                                        PIN_PUPD_PULLUP(GPIOA_PIN2) | \
                                        PIN_PUPD_PULLUP(GPIOA_PIN3) | \
                                        PIN_PUPD_PULLUP(GPIOA_LED5) | \
                                        PIN_PUPD_PULLUP(GPIOA_PIN5) | \
                                        PIN_PUPD_PULLUP(GPIOA_LED6) | \
                                        PIN_PUPD_PULLUP(GPIOA_LED7) | \
...
#define VAL_GPIOA_ODR                  (PIN_OD_HIGH(GPIOA_LED1) | \
                                        PIN_OD_HIGH(GPIOA_LED4) | \
                                        PIN_OD_HIGH(GPIOA_PIN2) | \
                                        PIN_OD_HIGH(GPIOA_PIN3) | \
                                        PIN_OD_LOW(GPIOA_LED5) | \
                                        PIN_OD_HIGH(GPIOA_PIN5) | \
                                        PIN_OD_HIGH(GPIOA_LED6) | \
                                        PIN_OD_HIGH(GPIOA_LED7) | \
...
#define VAL_GPIOA_AFRL                 (PIN_AFIO_AF(GPIOA_LED1, 2U) | \
                                        ...
                                        PIN_AFIO_AF(GPIOA_LED5, 0U) | \
                                        PIN_AFIO_AF(GPIOA_PIN5, 0U) | \
                                        PIN_AFIO_AF(GPIOA_LED6, 1U) | \
                                        PIN_AFIO_AF(GPIOA_LED7, 1U))
 ...
 *  GPIOF setup:
 *
 * PF0  - LED2                         (output, pushpull, startlow).
 * PF1  - LED3                         (output, pushpull, startlow).
 * PF2  - PIN2                         (unused).
 * PF3  - PIN3                         (unused).
 * PF4  - PIN4                         (unused).
 * PF5  - PIN5                         (unused).
 ...
 * PF15 - PIN15                        (unused).
*/
#define VAL_GPIOF_MODER                (PIN_MODE_OUTPUT(GPIOF_LED2) | \
...
#define VAL_GPIOF_OTYPER               (PIN_OTYPE_PUSHPULL(GPIOF_LED2) | \
...
#define VAL_GPIOF_OSPEEDR              (PIN_OSPEED_HIGH(GPIOF_LED2) | \
...
#define VAL_GPIOF_PUPDR                (PIN_PUPD_PULLUP(GPIOF_LED2) | \
                                        PIN_PUPD_PULLUP(GPIOF_LED3) | \
...
#define VAL_GPIOF_ODR                  (PIN_OD_LOW(GPIOF_LED2) | \
                                        PIN_OD_LOW(GPIOF_LED3) | \
...
#define VAL_GPIOF_AFRL                 (PIN_AFIO_AF(GPIOF_LED2, 0U) | \
